...
struct MembershipView: View {
    ...
    private let membership = PreviewJustMarriageServices.current.membership
                ...
                VStack(alignment: .leading, spacing: JMSpace.x4) {
                    ...
                    if let purchaseNotice {
                        HStack(alignment: .top, spacing: 10) {
                            Image(systemName: "exclamationmark.triangle.fill").foregroundColor(JMColor.yellow400)
                            Text(purchaseNotice)
                                .font(JMFont.sans(13.5, .semibold))
                    ...
                    JMButton("Join Just Marriage", variant: .primary, size: .lg, fullWidth: true, systemIcon: "arrow.right") {
