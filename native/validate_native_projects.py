...
checks = {
    ...
    ROOT / "android/app/src/main/java/com/justmarriage/app/SettingsScreen.kt": [
        ...
        "MembershipScreen(onClose",
        "GuaranteeScreen(onClose",
    ],
    ROOT / "android/app/src/main/java/com/justmarriage/app/MembershipScreen.kt": [
        "const val JM_PRICE = \"£2,500\"",
        "THE 99%",
        "MATCHED IN 6 MONTHS",
        "one-time · fully refundable",
        "How the guarantee works",
        "PreviewJustMarriageServices.current.membership",
        "purchaseNotice = PreviewJustMarriageServices.current.membership.purchasePremiumMembership().message()",
    ],
    ROOT / "android/app/src/main/java/com/justmarriage/app/GuaranteeScreen.kt": [
        "A MATCH IN 6 MONTHS",
        "OR YOUR MONEY BACK",
        "Pay once, upfront",
        "Or full refund",
    ...
    ROOT / "ios/JustMarriage/Screens/MembershipView.swift": [
        "let JM_PRICE = \"£2,500\"",
        "The 99%",
        "Matched in 6 months",
        "one-time · fully refundable",
        "How the guarantee works",
        "PreviewJustMarriageServices.current.membership",
        "purchaseNotice = membership.purchasePremiumMembership().message",
    ],
    ROOT / "ios/JustMarriage/Screens/GuaranteeView.swift": [
        "A match in 6 months",
        "or your money back",
        "Pay once, upfront",
        "Or full refund",
...
service_boundary_checks = {
    ...
    ROOT / "ios/JustMarriage/Services.swift": [
        ...
        "Payment service is required before membership can be activated.",
