...
echo -e "  - ${YELLOW}./dev-mode.sh${NC} - to use the local version of the package in both projects"
echo -e "  - ${YELLOW}./prod-mode.sh${NC} - to use the published version of the package in both projects" 