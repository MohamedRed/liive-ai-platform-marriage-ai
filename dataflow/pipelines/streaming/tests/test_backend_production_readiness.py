...
class BackendProductionReadinessTests(unittest.TestCase):
    ...
    def test_python_livekit_callable_requires_auth_and_only_reads_livekit_secrets(self):
        ...
        self.assertIn("firestore_client = firestore.client()", source)
        self.assertIn("firestore_client.collection(MATCHES_COLLECTION).document(uid).get()", source)
        self.assertIn("resolve_supervised_video_counterpart(uid, match_id, match_document)", source)
        self.assertIn("firestore_client.collection(MATCHES_COLLECTION).document(counterpart.matched_user_id).get()", source)
        self.assertIn("authorize_supervised_video_room(uid, match_id, match_document, matched_user_document)", source)
        ...
        self.assertIn('"matchedUserId": authorization.matched_user_id', source)
        self.assertIn('"waliId": authorization.wali_id', source)
        self.assertIn('"matchedUserWaliId": authorization.matched_user_wali_id', source)
        ...
        self.assertIn("def resolve_supervised_video_counterpart", auth_source)
        self.assertIn("def authorize_supervised_video_room", auth_source)
        self.assertIn("Reciprocal match document is unavailable", auth_source)
        self.assertIn("Missing reciprocal accepted match", auth_source)
        self.assertIn("Missing reciprocal wali authorization", auth_source)
    ...
    def test_match_acceptance_and_decline_are_server_authorized_state_transitions(self):
        ...
        self.assertIn("parseUnmatchPayload", match_acceptance_source)
        self.assertIn("buildUnmatchedMatchUpdate", match_acceptance_source)
        self.assertIn("match_unmatched", match_acceptance_source)
        self.assertIn("export const unmatch", source)
        self.assertIn("lastUnmatchedUserId", source)
        self.assertIn("reciprocalUnmatchedUpdate", source)
        self.assertIn("acceptance: {", match_acceptance_source)
        self.assertIn("status: \"revoked\"", match_acceptance_source)
        self.assertIn("transaction.set(matchRef", source)
        self.assertIn("transaction.set(matchedUserMatchRef", source)
        ...
        self.assertIn("isPermanentFcmTokenError", notification_source)
        self.assertIn("clearInvalidWaliFcmToken", notification_source)
        self.assertIn("fcmTokenInvalidatedAt", notification_source)
        self.assertIn("messaging/registration-token-not-registered", notification_source)
        self.assertIn("messaging/invalid-registration-token", notification_source)
    ...
    def test_marriage_safety_block_and_report_are_server_validated_and_server_only(self):
        ...
        self.assertIn("parseReviewMarriageReportPayload", safety_source)
        self.assertIn("parseResolveMarriageEscalationPayload", safety_source)
        self.assertIn("parseAcknowledgeMarriageWarningPayload", safety_source)
        self.assertIn("requireMarriageSafetyModerator", safety_source)
        self.assertIn("buildMarriageSafetyBlockWrite", safety_source)
        self.assertIn("buildMarriageSafetyReportWrite", safety_source)
        self.assertIn("buildMarriageSafetyReportReviewWrite", safety_source)
        self.assertIn("buildMarriageSafetyEscalationResolutionWrite", safety_source)
        self.assertIn("buildMarriageSafetyWarningAcknowledgementWrite", safety_source)
        self.assertIn("marriage_user_blocked", safety_source)
        self.assertIn("marriage_user_reported", safety_source)
        self.assertIn("marriage_report_reviewed", safety_source)
        self.assertIn("marriage_escalation_resolved", safety_source)
        self.assertIn("marriage_warning_acknowledged", safety_source)
        ...
        self.assertIn("USER_SAFETY_WARNINGS_COLLECTION", safety_source)
        self.assertIn("warningRecord", safety_source)
        self.assertIn("warningType: \"report_resolution\"", safety_source)
        self.assertIn("blockedUserIds", source)
        self.assertIn("reviewMarriageReport", source)
        self.assertIn("resolveMarriageSafetyEscalation", source)
        self.assertIn("acknowledgeMarriageSafetyWarning", source)
        self.assertIn("escalationResolutionWrite", source)
        self.assertIn("warningAcknowledgementWrite", source)
        ...
        self.assertIn("warningRef", source)
        self.assertIn("transaction.set(warningRef", source)
        ...
        self.assertIn("match /USER_SAFETY_WARNINGS/{document=**}", rules)
        self.assertIn("allow read, write: if false", rules)
